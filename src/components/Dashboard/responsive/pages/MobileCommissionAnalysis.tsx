...
import { BarChart3, Calendar, TrendingUp, Users, DollarSign, FileText, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg p-4 text-white">
            ...
            <div className="text-lg font-bold mr-14">{formatCurrency(monthlyData.montant_total)}</div>
