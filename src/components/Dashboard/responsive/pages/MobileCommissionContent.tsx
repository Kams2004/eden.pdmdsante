...
const MobileCommissionContent = ({ selectedPatients = [] }) => {
  const [startDate, setStartDate] = useState('');
  const [endDate, setEndDate] = useState('');
  const [selectAll, setSelectAll] = useState(false);

  const defaultPatients = [
    { id: 'P1', name: 'AHMADI ATEF AWAD', examination: 'CONSULTATION CARDIOLOGIQUE', commission: '9345.00 FCFA', transferDate: 'Feb 25, 2025', facture: 'Invoiced', selected: false },
    { id: 'P2', name: 'BIKIM BISSE PAUL EMMANUEL', examination: 'CONSULTATION NEUROLOGIQUE', commission: '9345.00 FCFA', transferDate: 'Feb 25, 2025', facture: 'Not Invoiced', selected: false },
    { id: 'P3', name: 'BIKIM BISSE PAUL EMMANUEL', examination: 'CONSULTATION NEUROLOGIQUE', commission: '9345.00 FCFA', transferDate: 'Feb 25, 2025', facture: 'Invoiced', selected: false },
    { id: 'P4', name: 'KAMELU MONIQUE', examination: 'HEMOGLOBINE GLYQUEE', commission: '1922.40 FCFA', transferDate: 'Feb 25, 2025', facture: 'Not Invoiced', selected: false },
    { id: 'P5', name: 'SALIHU ESUKUKU PETER', examination: 'EPREUVE D\'EFFORT', commission: '13320.00 FCFA', transferDate: 'Feb 25, 2025', facture: 'Invoiced', selected: false },
    { id: 'P6', name: 'SALIHU ESUKUKU PETER', examination: 'EPREUVE D\'EFFORT', commission: '20790.00 FCFA', transferDate: 'Feb 25, 2025', facture: 'Not Invoiced', selected: false },
  ];
  ...
  const getFactureColor = (facture) => {
    return facture === 'Invoiced' ? 'bg-green-500' : 'bg-red-500';
  };
      ...
      <div className="px-4 py-2">
        ...
        <div className="space-y-3">
          {patients.map((patient, index) => (
            <div key={patient.id || index} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
