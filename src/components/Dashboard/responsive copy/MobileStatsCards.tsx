...
import { faEye, faEyeSlash, faFileAlt, faPrescriptionBottle, faTasks, faWallet, faChartLine } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="flex items-center justify-between relative z-10">
          <div className="flex items-center">
            ...
            <div>
              ...
              {/* <p className="text-gray-600 text-xs">Analyse détaillée des commissions</p> */}
            </div>
          </div>
          <button
